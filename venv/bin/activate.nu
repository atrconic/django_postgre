...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/test/PycharmProjects/django_postgre/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/test/PycharmProjects/django_postgre/venv/bin/deactivate.nu'
